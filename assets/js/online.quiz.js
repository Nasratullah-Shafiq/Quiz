...
$("#btn-add-result").click(function(){
    ...
    var dataString = 'User_ID='+User_ID+'&TotalNumberOfQuestion='+TotalNumberOfQuestion+'&Username='+Username+'&Teacher='+Teacher+'&Subject='+Subject+'&Credit_Hours='+Credit_Hours+'&Attempted_Answer='+Attempted_Answer+'&Correct_Answer='+Correct_Answer+'&Wrong_Answer='+Wrong_Answer+'&No_Answer='+No_Answer+'&Result='+Result;
  ...
  $("#btn-signup").click(function(){
    ...
    var dataString = 'Full_Name='+Full_Name+'&Username='+Username+'&Password='+Password+'&Email='+Email+'&Gender='+Gender+'&Phone_No='+Phone_No;
    $.ajax({
      type: "POST",
      url: "GetSignup.php",
      data: dataString,
...
$("#btn-signin").click(function(){
  alert("Button clicked!");
    ...
    $(".empty, .incorrect, .failed, .error, .disable").hide();
    ...
    // Send AJAX only if validation passed
    $.ajax({
        type: "POST",
        url: "getLogin.php",
        data: {
        ...
        success: function(data){
            ...
            alert("Server Response: " + data); // debugging

            if($.trim(data) == "empty"){
                $(".empty").show();
            }
            else if($.trim(data) == "incorrect"){
                $(".incorrect").show();
            }
