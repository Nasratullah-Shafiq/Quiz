    	...
    	<div class="row" id="row">
            ...
            <div calss = "col-md-9">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class = ""> <a href="Add-Users.php"> <i class = "fa fa-user-plus"></i> Add User </a></li>
                </ol>
            </div>
                ...
                <form class=" "  method="POST">
                    <div class="form-group">
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" name ="searchUser" id ="searchUser" autocomplete="off" placeholder="Search for Users">
