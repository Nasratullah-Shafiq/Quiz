        ...
        <div id="navbar" class="navbar-collapse collapse text-right">
          ...
          <?php } ?>
            ...
            <li class="actie"><a id="ahmadsh" href="index.php"> صفحه اصلی <i class="fa fa-home"></i></a></li>
                ...
                <li><a href="./../../Dari/index.php"> بازدید امتحانات <i class="fa fa-list"></i></a></li>
...
<div class="jumbotron" id = "jbtdr" style="margin-bottom: 0px; background-image: url('./../../img/IBPS-Banner12.jpg'); background-size: cover;">
    <div class="container-fluid">
        <div id="detailsDr" class="animated fadeInLeft">
            <h1> مدیریت <span> امتحان دهی </span> آنلاین </h1>
            <p class = "paragraphDr"> امتحانات را اینجا مدیریت کنید</p>
        </div>
    </div>
</div>
<body>