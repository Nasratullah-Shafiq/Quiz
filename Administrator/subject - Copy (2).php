...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Handle every Export to Excel button
    document.querySelectorAll('.export-excel').forEach(function (button) {
        ...
        button.addEventListener('click', function (event) {
            ...
            // Get selected records from THIS table only
            const selectedIds = [];

            table
                .querySelectorAll('.record-checkbox:checked')
            ...
            form.method = 'POST';
            form.action = table.dataset.exportUrl;
            ...
            typeInput.value = table.dataset.exportType;
