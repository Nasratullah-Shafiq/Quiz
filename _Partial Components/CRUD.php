...
public function addResults($User_ID, $TotalNumberOfQuestion, $Username, $Teacher, $Subject, $Credit_Hours, $Attempted_Answer, $Correct_Answer, $Wrong_Answer, $No_Answer, $Result){
	...
	if ($TotalNumberOfQuestion == "" || $Username == "" || $Teacher == "" || $Subject == "" || $Credit_Hours == "" || $Attempted_Answer == "" || $Correct_Answer == "" || $Wrong_Answer == "" || $No_Answer == "" || $Result == "") {
		...
		exit();
			...
			$query = "INSERT into Result(User_ID, total_question, username, teacher, subject, credit_hours, attempted_answer, correct_answer, wrong_answer, no_answer, result) values('$User_ID', '$TotalNumberOfQuestion', '$Username', '$Teacher', '$Subject', '$Credit_Hours', '$Attempted_Answer', '$Correct_Answer', '$Wrong_Answer', '$No_Answer', '$Result')";
